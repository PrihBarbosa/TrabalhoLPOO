...
public class VendaDao {
    ...
    public ArrayList<Venda> all() throws SQLException {
        ...
        for (int i = 0; i < resultado.size(); i++) {
            ...
            //Venda vendas = new Venda(Integer.parseInt(array[0]), Integer.parseInt(array[1]), Integer.parseInt(array[2]), Double.parseDouble(array[3]));
            venda.add(vendas);
        }
        return venda;
    }
    ...
    public boolean update(Venda venda) {
        ...
        condicao.put("cod_Venda", venda.getCodVenda());
